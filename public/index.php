...
$routes = [
    ...
    'POST:admin/profile/update'                  => ['AdminController', 'updateProfile'],
    'POST:admin/profile/change-password'         => ['AdminController', 'changePassword'],
    'POST:admin/profile/upload-avatar'           => ['AdminController', 'uploadAvatar'],
    'POST:admin/profile/notification-prefs'      => ['AdminController', 'saveNotificationPrefs'],
    'POST:admin/profile/feedback'                => ['AdminController', 'submitFeedback'],
    'GET:admin/profile/revoke-sessions'          => ['AdminController', 'revokeSessions'],
    'GET:admin/feedback'                             => ['AdminController', 'feedback'],
    'POST:admin/feedback/review/toggle/{any}'        => ['AdminController', 'toggleReview'],
    'POST:admin/feedback/update/{any}'               => ['AdminController', 'updateFeedback'],
    'POST:admin/feedback/note/{any}'                 => ['AdminController', 'noteFeedback'],
    'POST:admin/feedback/delete/{any}'               => ['AdminController', 'deleteFeedback'],
    'POST:admin/feedback/reply/delete/{any}'         => ['AdminController', 'deleteReply'],
    'POST:admin/feedback/reply/edit/{any}'           => ['AdminController', 'editReply'],
    'POST:admin/users/{any}/delete'              => ['AdminController', 'deleteUser'],
    'POST:admin/users/{any}/toggle'              => ['AdminController', 'toggleUser'],
    ...
    'GET:auth/2fa/disable'  => ['TwoFactorController', 'showDisable'],
